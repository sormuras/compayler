...
public class ReadWriteLockPrevayler<P> implements Prevayler<P>, AutoCloseable {

  private final ReadWriteLock lock;
  private final Prevayler<P> prevayler;

  public ReadWriteLockPrevayler(Prevayler<P> prevayler) {
    this(prevayler, new ReentrantReadWriteLock());
  }

  public ReadWriteLockPrevayler(Prevayler<P> prevayler, ReadWriteLock lock) {
  ...
  public String toString() {
    return "ReadWriteLock(" + prevayler.toString() + ")";
  }
